...
const API_BASE_URL = process.env.REACT_APP_API_REMOTE_URL;
// const API_BASE_URL = process.env.REACT_APP_API_LOCAL_URL;
// Add validation
if (!API_BASE_URL) {
  console.warn('REACT_APP_API_LOCAL_URL is not defined in .env file');
  // Optionally provide a fallback for development
  // const API_BASE_URL = 'http://localhost:8080/api';
}

console.log('API Base URL:', API_BASE_URL); // More specific log
